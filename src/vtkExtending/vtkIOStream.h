...
VTKEXTENDING_EXPORT istream& vtkIOStreamScan(istream&, vtkIOStreamSLL&);
...
VTKEXTENDING_EXPORT istream& vtkIOStreamScan(istream&, vtkIOStreamULL&);
...
VTKEXTENDING_EXPORT ostream& vtkIOStreamPrint(ostream&, vtkIOStreamSLL);
...
VTKEXTENDING_EXPORT ostream& vtkIOStreamPrint(ostream&, vtkIOStreamULL);
