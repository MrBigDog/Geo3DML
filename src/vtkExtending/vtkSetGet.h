...
extern VTKEXTENDING_EXPORT void vtkOutputWindowDisplayText(const char*);
extern VTKEXTENDING_EXPORT void vtkOutputWindowDisplayErrorText(const char*);
extern VTKEXTENDING_EXPORT void vtkOutputWindowDisplayWarningText(const char*);
extern VTKEXTENDING_EXPORT void vtkOutputWindowDisplayGenericWarningText(const char*);
extern VTKEXTENDING_EXPORT void vtkOutputWindowDisplayDebugText(const char*);
