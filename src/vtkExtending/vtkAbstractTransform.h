...
class VTKEXTENDING_EXPORT vtkAbstractTransform : public vtkObject
{
public:
...
class VTKEXTENDING_EXPORT vtkTransformConcatenation
{
public:
...
// concatenations.
class VTKEXTENDING_EXPORT vtkTransformConcatenationStack
{
public:
